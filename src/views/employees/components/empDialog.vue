<template>
    <!-- 表单 -->
    <el-form :model="formData" :rules="rules" ref="addForm" label-width="120px">
        ...
        <el-form-item label="部门" prop="departmentName">
            ...
            <div v-if="showTree" class="tree-box">
                <el-tree :data="treeData" default-expand-all :props="{label:'name'}" @node-click="treeClick"></el-tree>
            </div>
        </el-form-item>
...
<script>
import EmployeeEnum from '@/api/constant/employees';// 聘用形式
...
export default {
    ...
    data(){
        return {
            ...
            hireType:EmployeeEnum.hireType,// 聘用形式枚举
            showTree:false,// 是否显示树形组件
            clickDepartName:''// 点击的部门名
        }
    },
    props:{
        treeData:{
